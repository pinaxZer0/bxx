	...
	var HallUI = function () {
		...
		_createClass(HallUI, [{
			...
			value: function create(opt, cb) {
				...
				Laya.loader.load([{ url: __webpack_require__(152), type: Loader.IMAGE }, { url: __webpack_require__(153), type: Loader.IMAGE }, { url: __webpack_require__(155), type: Loader.BUFFER }], Handler.create(null, function () {
					if (!!window.magiclink) {
					...
					_view.getChild('n47').onClick(null, function () {
						...
						netmsg.once('admin.addCoinsLog', null, function (pack) {
							...
							log.itemRenderer = Handler.create(null, function (idx, obj) {
								...
								obj.getChild('n2').text = '金豆:' + fstr(item.coins);
